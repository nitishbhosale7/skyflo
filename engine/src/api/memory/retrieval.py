...
class MemoryRetrievalService:
    ...
    async def retrieve_for_turn(
        ...
        Note: conversation_memory documents accumulate indefinitely per conversation.
        There is no TTL or per-conversation document cap enforced here. At scale,
        old conversation stores should be pruned by an external cleanup job.
        """
